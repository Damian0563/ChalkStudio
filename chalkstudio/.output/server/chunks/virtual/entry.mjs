...
import { createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, hasInjectionContext, getCurrentInstance, inject, getCurrentScope, toRef, shallowRef, isReadonly, defineComponent, ref, h, useSSRContext, isRef, isShallow, isReactive, toRaw, isVNode, createCommentVNode, Suspense, Fragment } from 'vue';
import { c as createError, $ as $fetch, l as hasProtocol, f as joinURL, w as withQuery, s as sanitizeStatusCode, p as parseURL, e as encodePath, m as decodePath, n as defu } from '../nitro/nitro.mjs';
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [{
	name: "slug",
	path: "/:slug(.*)*",
	component: () => import('../build/_...slug_-BjrUgBHL.mjs')
}, {
	name: "index",
	path: "/",
	component: () => import('../build/pages-9DT0iGuR.mjs')
}];
//#endregion
...
var app_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]);
//#endregion
...
var error_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
//#endregion
...
export { _plugin_vue_export_helper_default as _, entry as e };
